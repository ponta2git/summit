...
export const makeSession = (overrides: Partial<SessionRecord> = {}): SessionRecord => ({
  id: "session-1",
  weekKey: "2026-W17",
  postponeCount: 0,
...
export const makeMember = (overrides: Partial<MemberRecord> = {}): MemberRecord => ({
  id: "member-1",
...
export const makeResponse = (overrides: Partial<ResponseRecord> = {}): ResponseRecord => ({
  id: "response-1",
  sessionId: "session-1",
  memberId: "member-1",
