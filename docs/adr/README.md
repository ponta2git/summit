...
| Deploy / secrets / 運用権限 | [0005](./0005-operations-policy.md), [0011](./0011-dev-mention-suppression.md), [0052](./0052-remove-unused-healthcheck.md) |
...
| Tag | ADR |
|---|---|
| db | 0001, 0003, 0008, 0009, 0012, 0019, 0023, 0024, 0026, 0031, 0033, 0035, 0038, 0042, 0043, 0047, 0050, 0051, 0054 |
| discord | 0004, 0007, 0009, 0011, 0016, 0017, 0019, 0020, 0023, 0024, 0025, 0026, 0027, 0028, 0030, 0032, 0033, 0035, 0036, 0037, 0040, 0041, 0045, 0047, 0048, 0051, 0053, 0054 |
...
- ADR-0003（Postgres + Drizzle 運用）→ ADR-0049（DB 管理を @momo/db に分離）
...
- ADR-0034（healthcheck ping）→ ADR-0052（未使用 healthcheck 連携の撤去）
...
index.ts        ──► scheduler/, dispatcher, appContext, members/
```
...
| [0003](./0003-postgres-drizzle-operations.md) | Postgres データストアと Drizzle マイグレーション運用 | superseded | 2026-04-19 | db, runtime, ops |
...
| [0034](./0034-healthcheck-ping.md) | Healthcheck ping strategy — boot ping + minute-tick ping | superseded | 2026-04-28 | runtime, ops |
